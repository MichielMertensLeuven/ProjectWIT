...
C
      integer     n, N,     M,     NELE_JAC,     NELE_HESS,      IDX_STY
      parameter  (n = 50, M = 1, NELE_JAC = 8, NELE_HESS = 10)
      parameter  (IDX_STY = 1 )
C
...
C     Solve the steady state heat equation on the grid. Then calculate the 
C     amount of heat dissipation to find F.
C
C =============================================================================
C
...
C   Calculate using the adjoint senitivity analysis.
C
C =============================================================================
C
...
C   Jacobian of 1 inequality constraint: the maximum amount of material.
C
C =============================================================================
C
...
C   Write values of k in grid to an output file and the iteration number, 
C   value of obj function.
C =============================================================================
C
